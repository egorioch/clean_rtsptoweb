...
// По сути, ВСЕ функции возвращают в контекст код выполнения, связанный с конфигом
...
func HTTPAPIServerStreamChannelCodec(c *gin.Context) {
	...
	//Storage - это экземпляр класса StorageST, созданный в скрипте StorageStruct(взаим. с конфигом)
